      ...
      <div class="cart-content px-3 py-2">
        ...
        <div v-if="cart.length > 0">
          ...
          <div class="delivery-options">
            ...
            <input v-if="deliveryOption === 'delivery'" :disabled="isDisabled" type="text" v-model="deliveryAddress"
              placeholder="Enter Address" class="delivery-address">
            <input v-if="deliveryOption === 'delivery'" :disabled="isDisabled" type="text" v-model="phoneNumber"
              placeholder="Enter Phone" class="delivery-address">
  ...
  methods: {
    ...
    postDelivery() {
      const deliveryData = {
        ...
        customer: this.customerId, // You should replace this placeholder with the actual customer ID
...
/* Additional styles for delivery-related form fields can be added here */</style>
